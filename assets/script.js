...
if(issue.priority === "high"){
   ...
   borderStyle = `rounded-md border-t-4 border-green-500`;
    ...
    borderStyle = `rounded-md border-t-4 border-purple-500`;
        ...
        issueDiv.innerHTML = `
            <div class="p-3 bg-slate-200 space-y-4 ${borderStyle}">
            ...
            <div class="flex justify-between">
                <div><span class="border-1 rounded-full px-3 bg-red-100 p-1 text-red-700">${issue.labels[0]}</span></div>
                <div><span class="border-1 rounded-full px-3 bg-yellow-100 p-1 text-yellow-700">${issue.labels[1]}</span></div>
            </div>
